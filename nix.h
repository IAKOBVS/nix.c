...
int nix_rev(char *RESTRICT dest, const char *RESTRICT src, const size_t src_len);
int nix_rev_auto(char **RESTRICT dest, const char *RESTRICT src, const size_t src_len);
...
int nix_cat(char *RESTRICT dest, const char *RESTRICT filename, const size_t file_size);
int nix_cat_fast(char *RESTRICT dest, const char *RESTRICT filename, const size_t file_size);
